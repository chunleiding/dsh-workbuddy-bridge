...
function createQoderShim(options) {
	...
	return createShim({
		resolveCredential: () => store.resolve(),
		upstream: { chat: (credential, bodyJson, signal) => client.chatStream(credential, prepareQoderChatBody(bodyJson), signal) },
		catalog,
