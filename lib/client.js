window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region src/drivers/qoder/client/QoderPluginCard.tsx
		...
		//#endregion
		//#region src/drivers/qoder/client/locales.ts
		...
		//#endregion
		//#region src/drivers/qoder/client/index.tsx
		/**
		...
		* working.
		*/
		function registerQoderCard(ctx) {
			try {
				const namespace = "settings.qoder";
				ctx.effect(() => ctx.locale.register(namespace, {
					zh,
					en
				}), "dsh-llm-bridge: qoder settings copy");
				const t = ctx.locale.bind(namespace);
				ctx.slots.inject("settings.plugin.item", () => ctx.slots.register({
					name: "settings.plugin.item",
					key: "qoder",
