 ...
 * tsdown.config.ts), which replaces `__DSH_LLM_BRIDGE_VERSION__` with the
 ...
 *
 * @module dsh-llm-bridge/core/version
 */

declare const __DSH_LLM_BRIDGE_VERSION__: string

export const BRIDGE_VERSION: string =
  typeof __DSH_LLM_BRIDGE_VERSION__ === 'string' ? __DSH_LLM_BRIDGE_VERSION__ : '0.0.0-dev'
