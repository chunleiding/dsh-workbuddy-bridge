...
export const FALLBACK_QODER_MODELS: readonly QoderModelEntry[] = [
  ...
  { id: 'qmodel_38max', name: 'Qwen3.8-Max', contextWindow: 200_000, maxTokens: 32_000, supportsImages: true, reasoning: { supports: true, canDisableThinking: true, supportedEfforts: ['low', 'medium', 'xhigh'], defaultEffort: 'medium' }, billing: { credits: 'x0.5', badges: ['错峰 4 折'], free: true }, source: 'system', enabled: true, isDefault: true },
